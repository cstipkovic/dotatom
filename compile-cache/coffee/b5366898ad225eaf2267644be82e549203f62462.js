...
(function() {
  var AdmZip, cleanupOnUninstall, cliLocation, downloadFile, endsWith, enoughTimePassed, extractCLI, fileIsIgnored, fs, installCLI, installPython, isCLIInstalled, isCLILatest, isPythonInstalled, lastFile, lastHeartbeat, latestCLIVersion, os, packageVersion, path, process, pythonLocation, removeCLI, request, rimraf, sendHeartbeat, setupEventHandlers, unloadHandler, unzip;
