...
(function() {
  var AdmZip, cliLocation, downloadFile, endsWith, enoughTimePassed, extractCLI, fileIsIgnored, fs, installCLI, installPython, isCLIInstalled, isCLILatest, isPythonInstalled, lastFile, lastHeartbeat, latestCLIVersion, os, path, process, pythonLocation, request, rimraf, sendHeartbeat, setupConfig, setupEventHandlers, unzip;
  ...
  module.exports = {
    activate: function(state) {
      ...
      setupConfig();
      setupEventHandlers();
      return console.log('WakaTime v' + VERSION + ' loaded.');
    }
  };
  ...
  unzip = function(file, outputDir, cleanup) {
    var zip;
