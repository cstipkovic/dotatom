(function() {
  var Point, fillInNulls, getGuides, getVirtualIndent, mergeCropped, statesAboveVisible, statesBelowVisible, statesInvisible, toG, toGuides, uniq,
  ...
  mergeCropped = function(guides, above, below, height) {
    guides.forEach(function(g) {
      ...
      if (g.point.row + g.length - 1 === height) {
  ...
  getGuides = function(visibleFrom, visibleTo, lastRow, cursorRows, getIndentFn) {
    var above, below, guides, visibleIndents, visibleLast, _i, _results;
    ...
    guides = toGuides(visibleIndents, cursorRows.map(function(c) {
