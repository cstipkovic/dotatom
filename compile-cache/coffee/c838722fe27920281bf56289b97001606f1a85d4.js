...
(function() {
  var AdmZip, cleanupOnUninstall, cliLocation, downloadFile, endsWith, enoughTimePassed, extractCLI, fileIsIgnored, fs, getLatestCliVersion, installCLI, installPython, isCLIInstalled, isCLILatest, isPythonInstalled, lastFile, lastHeartbeat, os, packageVersion, path, process, pythonLocation, removeCLI, request, rimraf, sendHeartbeat, setupEventHandlers, unloadHandler, unzip;
    ...
    if (isWrite || enoughTimePassed(time) || lastFile !== file.path) {
      ...
      return pythonLocation(function(python) {
        ...
        if (python != null) {
          ...
          proc = process.execFile(python, args, function(error, stdout, stderr) {
            if (error != null) {
